// GENERATED from example/gen_ui_mock.md — keep the two in sync.
// `test/gen_ui/gen_ui_mock_document_test.dart` fails if they drift.

/// The gen-UI mock document: one markdown source exercising every widget
/// [GenUiRegistry.defaults] registers, plus the host-owned types it does not.
///
/// Rendered by `GenUiPreviewPage` for visual checks and by the widget tests.
/// The directives use the [genUiOpenMarker] / [genUiCloseMarker] private-use
/// delimiters, so the payloads below contain invisible characters.
library;

/// Markdown source of `example/gen_ui_mock.md`.
const String kGenUiMockDocument = r'''
