...
class _GenUiPreviewPageState extends State<GenUiPreviewPage> {
  ...
  GenUiRegistry _defaultRegistry() {
    return GenUiRegistry.defaults(
      ...
      unknownBuilder: (context, model) => _UnregisteredTypeChip(type: model.type),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final theme = brightness == baseTheme.brightness
        ? baseTheme
        : ThemeData(
        ...
        builder: (context) => Scaffold(
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                icon: Icon(
                  _incremental ? Icons.bolt : Icons.bolt_outlined,
                ),
                tooltip: _incremental
